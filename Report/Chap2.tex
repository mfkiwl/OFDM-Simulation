...
This chapter delves into designing an OFDM system. A combination of Python and Jupyter notebook is utilized to implement and simulate the designed. A full notebook can be seen in the Appendix. 
