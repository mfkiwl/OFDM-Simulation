...
\begin{itemize}
    \item Inter-symbol interference (ISI) due to multipath fading. The symbol period $T_{SC}$ must be much greater than maximal time delay $\tau_{max}$ in order to avoid ISI.
